--[[
  America 250 Liberty Flight theme configuration
  GPLv3
]] --
...
local function configure()
    ...
    local flight = form.addExpansionPanel("Freedom flight instruments")
    flight:open(true)
    ...
    local power = form.addExpansionPanel("Liberty power system")
    power:open(false)
    ...
    local thermal = form.addExpansionPanel("Thermal safeguards")
    thermal:open(false)
    ...
    local radio = form.addExpansionPanel("Radio link safeguards")
    radio:open(false)

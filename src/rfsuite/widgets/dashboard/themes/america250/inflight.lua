...
local function drawVerticalMeter(x, y, w, h, title, value, maximum, color, valueText)
    ...
    drawTextAligned(x + 38, y + 48, w - 50, valueText or "--", "FONT_L", C.white, "left")
...
local function inflightPaint(x, y, w, h, box, c, telemetry)
    ...
    drawTextAligned(centerX, cy - 32, centerW, c.rpmText or "--", "FONT_XXL", C.white, "center")
    drawTextAligned(centerX, cy + 22, centerW, "HEADSPEED  RPM", "FONT_XS", C.muted, "center")
    drawTextAligned(centerX + 22, bodyY + bodyH - 34, centerW - 44, c.maxRpmText or "MAX --", "FONT_XS", C.amber, "left")
